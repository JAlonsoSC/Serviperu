...
public class ControlEmpresasNew {
    ...
    public String nuevo(@RequestParam String Nombre,
        ...
        String res1 = serviceEmpresas.crear(codigo,Nombre,Direccion,Ciudad,codPostal,Telefono,Correo);
        String res = serviceContratos.crear(codigo,FechaConfirmacion,FechaInicio,FechaFinal);
